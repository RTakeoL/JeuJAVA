...
public class Jeu {
	...
	//			}
	 ...
	 private void creerPNJ() {
			...
			PersoNonJoueur Zombie = new PersoNonJoueur("Zombie", "zombie.jpg", "Oh non, un zombie est déjà dans le supermarché...." + 
			" Il faut faire quelque chose pour le faire fuir, ou le tuer.. une seconde fois...",
					"", 
					"",
					"");
